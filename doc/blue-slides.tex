...
\logo{\includegraphics[width=1.8cm]{img/seal_black.pdf}\hspace*{10cm}~\includegraphics[height=2cm]{img/ACL_logo.png}}
...
\begin{frame}{To Do}
    \begin{itemize}
        ...
        \item Rewrite customization
        \item Fix logo locations in title
    \end{itemize}
\end{frame}
