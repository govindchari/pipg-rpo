...
static emlrtRTEInfo eb_emlrtRTEI = {
    1,                            /* lineNo */
    1,                            /* colNo */
    "_coder_pipg_vec_solver_api", /* fName */
    ""                            /* pName */
};
                               ...
                               const emlrtMsgIdentifier *parentId, struct0_T *y)
{
  ...
  y->th_ac = c_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 9, "th_ac")),
      &thisId);
  thisId.fIdentifier = "umax";
  y->umax = c_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 10, "umax")),
      &thisId);
  ...
  f_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 13, "B")),
      &thisId, y->B);
  thisId.fIdentifier = "Q";
  e_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 14, "Q")),
      &thisId, y->Q);
  thisId.fIdentifier = "R";
  g_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 15, "R")),
      &thisId, y->R);
  thisId.fIdentifier = "Px";
  e_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 16, "Px")),
      &thisId, y->Px);
  thisId.fIdentifier = "Pu";
  g_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 17, "Pu")),
      &thisId, y->Pu);
  thisId.fIdentifier = "x0s";
  d_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 18, "x0s")),
      &thisId, y->x0s);
  thisId.fIdentifier = "xNs";
  d_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 19, "xNs")),
      &thisId, y->xNs);
  emlrtDestroyArray(&u);
}
                               ...
                               const emlrtMsgIdentifier *parentId, struct1_T *y)
{
  ...
  n_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 3, "H")),
      &thisId, &y->H);
  thisId.fIdentifier = "Ht";
  o_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 4, "Ht")),
      &thisId, &y->Ht);
  ...
  p_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 7, "xi")),
      &thisId, y->xi);
  thisId.fIdentifier = "eta";
  q_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 8, "eta")),
      &thisId, y->eta);
  emlrtDestroyArray(&u);
}
